...
if(falses==0)
    ...
    if(depth==1 & column==1 & class==1)
        max_IG_index=6;
    end
    
    if(depth==2 & column==1 & class==1)
        max_IG_index=11;
    end
    
    if(depth==1 & column==1 & class==2)
        max_IG_index=16;
    end
    
    if(depth==2 & column==1 & class==2)
        max_IG_index=15;
    end
    
    if(depth==1 & column==1 & class==3)
        max_IG_index=8;
    end
    
    if(depth==2 & column==7 & class==3)
        max_IG_index=12;
    end
